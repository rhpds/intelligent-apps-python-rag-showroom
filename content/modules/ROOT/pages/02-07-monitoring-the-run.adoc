...
* [x] Monitored the two-component pipeline graph in real time: `fetch-data-from-api` completed, then `ingest-incidents-to-milvus` ran to completion
* [x] Inspected per-component container logs to confirm the API returned data and the embeddings were inserted into Milvus
