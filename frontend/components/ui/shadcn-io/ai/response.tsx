...
const components: Options['components'] = {
  ...
  a: ({ node, children, className, href, ...props }) => {
    // PDFs should open in a new tab, other links should use _parent to stay in iframe context
    const isPdf = href?.endsWith('.pdf') || href?.includes('/_/techdocs/');
    const target = isPdf ? '_blank' : '_parent';
